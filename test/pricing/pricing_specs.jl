...
mutable struct PricingSpecs
	...
	lb::Array{Int}				#vector of lower bounds
	ub::Array{Int}				#vector of upper bounds
	obj_c::Array{Float64}		#vector of objective coeffcients
	obj_d::Array{Float64}		#vector of degrees of variables in the objective
	...
	constr_rhs::Array{Float64}	#rhs value of constraints
end
