# This file includes modification of the DD graph based on the Metagraph.jl module

# For the use of a customized DD without the use of the Metagraph, use file "core.jl"
